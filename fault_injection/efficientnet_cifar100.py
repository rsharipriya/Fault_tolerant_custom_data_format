"""
unified_ptq_fault_robustness_efficientnet_cifar100.py  [FINAL]
═══════════════════════════════════════════════════════════════════════════════
PTQ-WOQ fault-robustness  —  EfficientNet-B0 / CIFAR-100
...
─────────────────────────────────────────────
  ...
  classifier     : Linear(in_features, 10)
  PTH            : efficientnet_cifar100.pth
═══════════════════════════════════════════════════════════════════════════════
"""
...
PTH_PATH     = "efficientnet_cifar100.pth"
NUM_CLASSES  = 100
DATASET_NAME = "CIFAR-100"
MODEL_NAME   = "EfficientNet-B0"
OUT_PREFIX   = "ptq_unified_efficientnet_cifar100"
BATCH_SIZE   = 256
N_TRIALS     = 100
...
def load_model():
    """EfficientNet-B0 for CIFAR-10: stride-1 stem, 100-class head."""
