"""
unified_ptq_fault_robustness_mobilenetv2_tinyimagenet.py  [FINAL]
═══════════════════════════════════════════════════════════════════════════════
PTQ-WOQ fault-robustness  —  MobileNetV2 / Tiny ImageNet
...
──────────────────────────────────────────────────
  ...
  classifier[1]  : Linear(1280, 200)
  PTH            : mobilenetv2_tiny_imagenet.pth
...
PTH_PATH          = "mobilenetv2_tiny_imagenet.pth"
NUM_CLASSES       = 200
DATASET_NAME      = "Tiny ImageNet"
MODEL_NAME        = "MobileNetV2"
OUT_PREFIX        = "ptq_unified_mobilenetv2_tinyimagenet"
...
def load_model():
    """MobileNetV2 for Tiny ImageNet: stride-1 stem, 200-class head."""
...
if __name__=="__main__":
    parser=argparse.ArgumentParser(description=f"PTQ-WOQ fault robustness  —  {MODEL_NAME} / {DATASET_NAME}")
