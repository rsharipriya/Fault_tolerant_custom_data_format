"""
unified_ptq_fault_robustness_mobilenetv2_cifar100.py  [FINAL]
═══════════════════════════════════════════════════════════════════════════════
PTQ-WOQ fault-robustness  —  MobileNetV2 / CIFAR-1000
...
─────────────────────────────────────────────
  ...
  classifier[1]  : Linear(1280, 100)
  PTH            : mobilenetv2_cifar100.pth
═══════════════════════════════════════════════════════════════════════════════
"""
...
PTH_PATH     = "mobilenetv2_cifar100.pth"
NUM_CLASSES  = 100
DATASET_NAME = "CIFAR-100"
MODEL_NAME   = "MobileNetV2"
OUT_PREFIX   = "ptq_unified_mobilenetv2_cifar100"
BATCH_SIZE   = 256
N_TRIALS     = 100
